...
public class BaseDatos extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        db.execSQL("create table prestamo(id integer primary key autoincrement, cedulaCliente text, monto real, periodo integer, tipo text, mensualidad real, saldo real, cuotasPagadas integer, foreign key(cedulaCliente) references Cliente(cedula))");
